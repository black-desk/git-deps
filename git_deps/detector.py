...
class DependencyDetector(object):
    ...
    def process_blame_hunk(self, dependent, dependent_sha1, parent,
        ...
        # Handle both pygit2.Oid and our custom GitRef objects
        orig_commit_id = blame_hunk.orig_commit_id
        if hasattr(orig_commit_id, 'hex'):
            # Custom GitRef object from subprocess blame
            dependency_sha1 = orig_commit_id.hex
        else:
            # pygit2.Oid object from pygit2 blame
            dependency_sha1 = str(orig_commit_id)
